...
| `export-public-snapshot.mjs` | `npm run snapshot:public` | Filtered **progress-report** copy for `Mission-Winning/missionwinning`. Sibling dir, orphan git, **does not push**, does not change origin. Deny rules: [public-snapshot/](public-snapshot/INDEX.md) |
